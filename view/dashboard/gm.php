...
<div class="container">
    <h2 style="color:#848795">Reporte de las ganancias mensuales</h2>
</div><br>

 <?php
                                                        $consulta2 = "select * from compra co inner join cliente cli on co.id_cliente = cli.id_cliente where EXTRACT(MONTH FROM fecha)=(SELECT EXTRACT(MONTH FROM DATE(NOW()))) and EXTRACT(YEAR FROM fecha)=(SELECT EXTRACT(YEAR FROM DATE(NOW())))";
